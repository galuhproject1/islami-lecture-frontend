...
import ModalAction from "../../../components/reusable/Modal/ModalAction";

const DetailClassPage = () => {
  const router = useNavigate();
  return (
    <Box>
      <ModalAction open title="Mohon Maaf" desc="Fitur ini akan tersedia sebentar lagi" onClose={() => router(-1)} onSubmit={() => router(-1)} />
    </Box>
